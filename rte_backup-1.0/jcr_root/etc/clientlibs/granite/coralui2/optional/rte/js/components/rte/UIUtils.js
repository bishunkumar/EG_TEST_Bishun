    ...
    CUI.rte.UIUtils = function() {
        ...
        return {
            ...
            getUIContainer: function($editable) {
                ...
                if (!editableDom
                        || !CUI.rte.Common.hasCSS(editableDom, "coral-RichText-ui")) {
                    return null;
                }
                return $(editableDom);
            },
            ...
            getToolbar: function($editableOrContainer, tbType) {
                ...
                var $container = $editableOrContainer.hasClass("coral-RichText-ui") ?
                        $editableOrContainer :
                ...
                var $toolbar = $container.find(
                        "div[data-type=\"" + tbType + "\"] > div.coral-RichText-toolbar");
            ...
            getPopoverTrigger: function(ref, tbType, $containerOrToolbar) {
                tbType = tbType || "inline";
                var $toolbar = ($containerOrToolbar.hasClass("coral-RichText-toolbar") ?
                        $containerOrToolbar :
